#!/usr/bin/env python3
"""
Test thermal detection on image DJI_20241106194532_0353_T.
"""
...
IMAGE: DJI_20241106194532_0353_T
...
579.0, -180.8"""
    ...
    print("=" * 80)
    print("THERMAL DETECTION VALIDATION TEST - IMAGE 0353")
    print("=" * 80)
    ...
    output_path = output_dir / "thermal_detection_validation_0353.png"
    ...
    if metrics_05['f1_score'] < 0.05:
        ...
        print(f"? F1 score ({metrics_05['f1_score']:.3f}) higher than documentation")
