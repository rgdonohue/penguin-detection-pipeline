...
**Proven Alternative**: LiDAR height-above-ground detection successfully identifies penguin-sized objects (802 detections in test area with reproducible pipeline results).
