...
1. **LiDAR detection** (primary): Processes field data, produces several hundred candidate detections per tile (862 on test tile with tuned parameters)
...
- Test tile: 862 detections (reproducible with fixed parameters)
